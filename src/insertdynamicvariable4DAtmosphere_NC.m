function insertdynamicvariable4DAtmosphere_NC(Filename, Variable, VarName, StdName, LongName, Units, NULLValue)
    ...
    [lon_Dim, lat_Dim, level_Dim, time_Dim]=size(Variable);
    nccreate(Filename, VarName,'Dimensions',{'lon', lon_Dim, 'lat', lat_Dim, 'level', level_Dim, 'time', time_Dim},'Format','classic')
