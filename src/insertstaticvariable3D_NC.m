function insertstaticvariable3D_NC(Filename, Variable, VarName, StdName, LongName, Units, NULLValue)
    ...
    [lon_Dim, lat_Dim, depth_Dim]=size(Variable);
    nccreate(Filename, VarName,'Dimensions',{'lon', lon_Dim,'lat', lat_Dim,'depth', depth_Dim},'Format','classic')
