function insertvariable2D_NC(Filename, Variable, VarName, StdName, LongName, Units, NULLValue)
    ...
    [lon_Dim, lat_Dim]=size(Variable);
    nccreate(Filename, VarName,'Dimensions',{'lon',lon_Dim,'lat',lat_Dim},'Format','netcdf4_classic')
